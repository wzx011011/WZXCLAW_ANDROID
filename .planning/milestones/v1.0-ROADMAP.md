...
Plans:
- [x] 06-01-PLAN.md — Relay server: FCM module (firebase-admin SDK) + offline message queue with 24h TTL + push notification on task-complete events
- [x] 06-02-PLAN.md — Flutter client: NotificationService singleton (FCM init, background handler, foreground suppression, notification tap navigation) + Android build config for Firebase
- [x] 06-03-PLAN.md — UI: push notification toggle in settings page + offline sync SnackBar on home page
